...
// Encoded value: [1, 0, [[["127.0.0.1", 59074]], 1, {0: ["read", {}, {0:
// ["value", {}], 1: ["error", {}]}], 1: ["write", {}, {0: ["value", {}], 1:
// ["error", {}]}], 2: ["remove", {}, {0: ["value", {}], 1: ["error", {}]}], 3:
// ["find", {}, {0: ["value", {}], 1: ["error", {}]}]}], [[80, 81, 82]]].
const COMPLEX: &[u8] = [
...
fn from_complex_write_value_ref(b: &mut Bencher) {
    ...
    let val = Array(vec![
        ...
        Map(vec![(String("key"), String("value"))]),
    ]);
