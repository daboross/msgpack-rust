...
/// # Errors
///
/// This function returns Error with an underlying I/O error if unable to
/// properly write entire value. Interruption errors are handled internally by
/// silent operation restarting.
///
/// # Examples
/// ```
/// use rmpv::{encode::write_value_ref, ValueRef};
///
/// let mut buf = Vec::new();
    ...
    W: Write,
{
    match *val {
        ...
        ValueRef::Ext(ty, data) => {
            ...
            wr.write_all(data)
                .map_err(|err| Error::InvalidDataWrite(err))?;
        }
    }
