...
/// Encodes and attempts to write an `f32` value as a 5-byte sequence into the
/// given write.
///
/// The first byte becomes the `f32` marker and the others will represent the
/// data itself.
///
/// # Errors
///
...
/// Encodes and attempts to write an `f64` value as a 9-byte sequence into the
/// given write.
///
/// The first byte becomes the `f64` marker and the others will represent the
/// data itself.
///
/// # Errors
///
