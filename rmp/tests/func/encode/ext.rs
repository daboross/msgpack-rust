...
fn pass_pack_meta_fix1() {
    ...
    assert_eq!(
        Marker::FixExt1,
        write_ext_meta(&mut &mut buf[..], 1, 16).unwrap()
    );
...
fn pass_pack_meta_fix2() {
    ...
    assert_eq!(
        Marker::FixExt2,
        write_ext_meta(&mut &mut buf[..], 2, 16).unwrap()
    );
...
fn pass_pack_meta_fix4() {
    ...
    assert_eq!(
        Marker::FixExt4,
        write_ext_meta(&mut &mut buf[..], 4, 16).unwrap()
    );
...
fn pass_pack_meta_fix8() {
    ...
    assert_eq!(
        Marker::FixExt8,
        write_ext_meta(&mut &mut buf[..], 8, 16).unwrap()
    );
...
fn pass_pack_meta_fix16() {
    ...
    assert_eq!(
        Marker::FixExt16,
        write_ext_meta(&mut &mut buf[..], 16, 16).unwrap()
    );
...
fn pass_pack_meta_8() {
    ...
    assert_eq!(
        Marker::Ext8,
        write_ext_meta(&mut &mut buf[..], 255, 16).unwrap()
    );
...
fn pass_pack_meta_16() {
    ...
    assert_eq!(
        Marker::Ext16,
        write_ext_meta(&mut &mut buf[..], 65535, 16).unwrap()
    );
...
fn pass_pack_meta_32() {
    ...
    assert_eq!(
        Marker::Ext32,
        write_ext_meta(&mut &mut buf[..], 4294967295, 16).unwrap()
    );
